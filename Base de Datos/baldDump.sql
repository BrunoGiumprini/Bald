...
CREATE TABLE `acerca` (
  ...
  PRIMARY KEY (`IdNotificacion`,`idPartido`),
  CONSTRAINT `fk_acercajuega` FOREIGN KEY (`idPartido`) REFERENCES `juega` (`idPartido`),
...
CREATE TABLE `acontece` (
  ...
  PRIMARY KEY (`idPartido`,`NombreCampeonatoInternacional`),
  ...
  CONSTRAINT `fk_acontecepartidointer` FOREIGN KEY (`idPartido`) REFERENCES `partidointernacional` (`idPartido`)
) ;
...
INSERT INTO `atleta` VALUES ('Cristiano','Ronaldo','cr7.jpg'),('Lebron','James','lbj.png'),('Leonel','Messi','mesi.png'),('Lewis','Hamilton','ham.jpg'),('Rafael','Nadal','rafa.png');
...
CREATE TABLE `campeonato` (
  ...
  PRIMARY KEY (`Nombre`),
  KEY `fk_deportecampeonato_idx` (`Deporte`),
  CONSTRAINT `fk_nombrecampeonatodeporte` FOREIGN KEY (`Deporte`) REFERENCES `deporte` (`NombreDeporte`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `campeonato` VALUES ('Champions','FIFA','2023-01-09','2022-01-09','elbichosiu','Europa','Futbol'),('Copa America','Conmebol','2022-09-01','2022-09-01','futbol suarez','Brasil','futbol'),('F1','Europa','2007-01-02','2007-03-01','F1 hamilton','Italia','F1'),('Mundial','FIFA','2012-02-13','2012-07-01','futbol messi','Qatar','Futbol'),('NBA','USA','2021-01-12','2021-10-01','basketball lebron ','USA','Basketball'),('Olimpiadas','ONU','2034-08-22','2035-01-01','olimpiadas phelps','Mundial','Multideportivo'),('Roland Garros','Tenis fifa','2001-02-02','2002-01-01','tenis federer','Suiza','Tenis');
...
CREATE TABLE `compite` (
  ...
  PRIMARY KEY (`CodigoPais`,`idPartido`),
  KEY `fk_compitepartidointer_idx` (`idPartido`),
  CONSTRAINT `fk_compitepais` FOREIGN KEY (`CodigoPais`) REFERENCES `pais` (`CodigoPais`),
  CONSTRAINT `fk_compitepartidointer` FOREIGN KEY (`idPartido`) REFERENCES `partidointernacional` (`idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `evento` (
  ...
  KEY `idx_apellidonombreatleta` (`AtletaNombre`,`AtletaApellido`),
  CONSTRAINT `FK_nombreapellidoatleta` FOREIGN KEY (`AtletaNombre`,`AtletaApellido`) REFERENCES `atleta` (`Nombre`, `Apellido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `evento` VALUES (1,'Gol','Cristiano', 'Ronaldo', 32),(2,'triple','Lebron', 'James', 45),(3,'falta-tarjeta amarilla','Lionel', 'Messi', 23),(4,'neumatico explotado','Lewis', 'Hamilton', 4),(5,'punto','Rafael', 'Nadal', 13);
...
CREATE TABLE `incluye` (
  ...
  KEY `CodPais` (`CodPais`,`idPartido`),
  CONSTRAINT `incluye_ibfk_1` FOREIGN KEY (`CodPais`, `idPartido`) REFERENCES `compite` (`CodigoPais`,`idPartido`),
...
CREATE TABLE `juega` (
  ...
  PRIMARY KEY (`idPartido`,`CodigoEquipo`),
  KEY `fk_CodigoEquipo_idx` (`CodigoEquipo`),
  KEY `juega_idx` (`CodigoEquipo`,`idPartido`),
  KEY `idx_juegaacerca` (`idPartido`),
  CONSTRAINT `fk_CodigoEquipo` FOREIGN KEY (`CodigoEquipo`) REFERENCES `equipo` (`CodigoEquipo`),
  CONSTRAINT `fk_idPartidojuega` FOREIGN KEY (`idPartido`) REFERENCES `partidos` (`idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ocurren` (
  `idPartido` int NOT NULL,
  `NombreCampeonato` varchar(45) NOT NULL,
  PRIMARY KEY (`idPartido`,`NombreCampeonato`),
  ...
  CONSTRAINT `fk_ocurrenpartidoclub` FOREIGN KEY (`idPartido`) REFERENCES `partidosclub` (`idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ostenta` (
  ...
  `idPartido` int NOT NULL,
  PRIMARY KEY (`idResultado`),
  KEY `CodEquipo` (`CodEquipo`,`idPartido`),
  CONSTRAINT `ostenta_ibfk_1` FOREIGN KEY (`idResultado`) REFERENCES `resultado` (`idResultado`),
  CONSTRAINT `ostenta_ibfk_2` FOREIGN KEY (`CodEquipo`, `idPartido`) REFERENCES `juega` (`CodigoEquipo`, `idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `partidointernacional` (
  ...
  CONSTRAINT `fk_idPartidoInter` FOREIGN KEY (`idPartido`) REFERENCES `partidos` (`idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `partidos` VALUES ('0','08:00:00','Pamukkale','2011-04-12','12:00:00'),('1','13:00:00','Anfield','2012-04-03','15:00:00'),('2','13:00:00','Old Traford','2015-02-23','15:00:00'),('3','14:00:00','Camp Nou','2010-12-02','16:00:00'),('4','15:00:00','Staples Center','2021-12-01','17:00:00'),('5','18:00:00','Centenario','2023-06-02','20:00:00'),('6','19:00:00','Bernabeu','2021-10-11','21:00:00'),('7','19:00:00','Bernabeu','2021-11-11','21:00:00'),('8','19:00:00','Bombonera','2020-11-11','21:00:00'),('9','21:00:00','Le Mans','2001-01-01','00:00:00');
...
CREATE TABLE `partidosclub` (
  ...
  CONSTRAINT `fk_idPartido` FOREIGN KEY (`idPartido`) REFERENCES `partidos` (`idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pasan` (
  ...
  `CodigoEquipo` int NOT NULL,
  `idPartido` int NOT NULL,
  PRIMARY KEY (`IdEvento`,`CodigoEquipo`,`idPartido`),
  KEY `fk_pasanjuega_idx` (`CodigoEquipo`,`idPartido`),
  CONSTRAINT `fk_pasanevento` FOREIGN KEY (`IdEvento`) REFERENCES `evento` (`IDEvento`),
  CONSTRAINT `fk_pasanjuega` FOREIGN KEY (`CodigoEquipo`, `idPartido`) REFERENCES `juega` (`CodigoEquipo`, `idPartido`)
) ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sucede` (
  ...
  `CodPais` varchar(2) NOT NULL,
  `idPartido` int NOT NULL,
  PRIMARY KEY (`IdEvento`,`CodPais`,`idPartido`),
  KEY `fk_compitesucede_idx` (`CodPais`,`idPartido`),
  CONSTRAINT `fk_compitesucede` FOREIGN KEY (`CodPais`, `idPartido`) REFERENCES `compite` (`CodigoPais`, `idPartido`),
