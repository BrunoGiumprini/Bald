...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2022 a las 22:30:15
...
INSERT INTO `atleta` (`idAtleta`, `Nombre`, `Apellido`) VALUES
(1, 'Cristiano', 'Ronaldo'),
(2, 'Lebron', 'James'),
(3, 'Leonel', 'Messi'),
(4, 'Lewis', 'Hamilton'),
...
--
INSERT INTO `bald`.`campeonato` (`Nombre`, `Organizador`, `FechaFin`, `FechaInicio`, `Descripcion`, `Ubicacion`) VALUES ('Copa Libertadores De America', 'FIFA', '2022-01-01', '2023-03-23', 'messi gol', 'Uruguay');
INSERT INTO `campeonato` (`Nombre`, `Organizador`, `FechaFin`, `FechaInicio`, `Descripcion`, `Ubicacion`) VALUES
('campeonato de clubes', 'franco', '2022-11-18', '2022-11-18', 'si 33', 'uy'),
...
INSERT INTO `compite` (`CodigoPais`, `idPartido`, `NombreArbitro`) VALUES
('pr', 27, 'fsafsafas'),
('uy', 27, 'fsafsafas');
...
--
DELIMITER $$
CREATE TRIGGER `atletaidevento` BEFORE INSERT ON `evento` FOR EACH ROW begin 
if(select evento.idAtleta 
from evento
where evento.idAtleta IN (select atleta.idAtleta
from atleta) )
...
CREATE TABLE `juega` (
  ...
  `Encuentro` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `juega` (`idPartido`, `CodigoEquipo`, `NombreArbitro`, `Alineacion`, `Encuentro`) VALUES
(15, 1, 'NoJose NoPancho', '4-4-2', NULL),
(15, 9, 'NoJose NoPancho', '4-4-2', NULL);
...
INSERT INTO `partidos` (`idPartido`, `HoraComienzo`, `DondeSeJuega`, `Fecha`) VALUES
(0, '08:00:00', 'Pamukkale', '2011-04-12'),
(1, '13:00:00', 'Anfield', '2012-04-03'),
(2, '13:00:00', 'Old Traford', '2015-02-23'),
(3, '14:00:00', 'Camp Nou', '2010-12-02'),
(4, '15:00:00', 'Staples Center', '2021-12-01'),
(5, '18:00:00', 'Centenario', '2023-06-02'),
(6, '19:00:00', 'Bernabeu', '2021-10-11'),
(7, '19:00:00', 'Bernabeu', '2021-11-11'),
(8, '19:00:00', 'Bombonera', '2020-11-11'),
(9, '21:00:00', 'Le Mans', '2001-01-01'),
(13, '13:15:00', 'Bernabeu', '2022-11-11'),
(15, '11:14:00', 'Bernabeu', '2022-11-19'),
(16, '11:16:00', 'Bernabeu', '2022-11-09'),
(17, '11:17:00', 'Bernabeu', '2022-11-11'),
(18, '14:18:00', 'NoUbi', '2022-11-10'),
(19, '11:22:00', 'Bernabeu', '2022-11-11'),
(20, '14:20:00', 'NoUbi', '2022-11-16'),
(21, '14:22:00', 'NoUbi', '2022-11-10'),
(22, '15:24:00', 'aaaa', '2022-11-17'),
(23, '15:24:00', 'aaaa', '2022-11-17'),
(24, '15:24:00', 'aaaa', '2022-11-17'),
(25, '15:24:00', 'aaaa', '2022-11-17'),
(26, '15:24:00', 'aaaa', '2022-11-17'),
(27, '14:32:00', 'Bernabeu', '2022-11-15');
...
--
-- Volcado de datos para la tabla `partidosclub`
--

INSERT INTO `partidosclub` (`idPartido`) VALUES
(15);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `tgridatletaevento` BEFORE INSERT ON `posiciona` FOR EACH ROW begin 
if(select posiciona.idAtleta 
from posiciona
where posiciona.idAtleta IN (select tiene.idAtleta
from tiene) )
then insert into posiciona(idAtleta,titular,posicion)VALUES(inserted.idAtleta,inserted.titular,inserted.posicion);
end if;
end
...
(1, 'MC', 'mc.com', 'publicidad.png'),
(2, 'BK', 'bk.com', 'publicidad2.png'),
(3, 'Mdeo Shoping', 'mdeo.com', 'publicidad.png'),
(4, 'Poweade', 'power.com', 'publicidad2.png'),
(5, 'Coscu', 'coscu.com', 'publicidad.png'),
(6, 'Rexona', 'rexona.com', 'publicidad2.png'),
(7, 'McDonalds', 'https://www.mcdonalds.com', 'NBA-logo-png-download-free.png');
...
INSERT INTO `tiene` (`idAtleta`, `CodigoEquipo`) VALUES
(3, 9);
...
--
-- AUTO_INCREMENT de la tabla `ostenta`
--
ALTER TABLE `ostenta`
...
--
ALTER TABLE `partidos`
  MODIFY `idPartido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `publicidad`
--
ALTER TABLE `publicidad`
  MODIFY `idPublicidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `campeonatointernacional`
  ADD CONSTRAINT `campeonatointernacional_ibfk_1` FOREIGN KEY (`Nombre`) REFERENCES `campeonato` (`Nombre`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `incluye`
  ...
  ADD CONSTRAINT `incluye_ibfk_3` FOREIGN KEY (`CodPais`) REFERENCES `compite` (`CodigoPais`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `incluye_ibfk_4` FOREIGN KEY (`idPartido`) REFERENCES `partidos` (`idPartido`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ostenta`
  ADD CONSTRAINT `ostenta_ibfk_2` FOREIGN KEY (`CodEquipo`) REFERENCES `equipo` (`CodigoEquipo`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `partidointernacional`
  ADD CONSTRAINT `partidointernacional_ibfk_1` FOREIGN KEY (`idPartido`) REFERENCES `compite` (`idPartido`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `practican`
  ...
  ADD CONSTRAINT `practican_ibfk_1` FOREIGN KEY (`NombreCampeonato`) REFERENCES `campeonato` (`Nombre`) ON DELETE CASCADE ON UPDATE CASCADE;
