...
<body style="background-color: #000000;">
                ...
                <div class="modal-body">
                 ...
                 <div class="input-group mb-3">
                  ...
                  <p class="textop fw-bold">ingresar fecha del partido</p>
                    ...
                    <p class="textop fw-bold">ingresar un codigo de equipo</p>
                    <div class="input-group mb-3">
                        <input type="date" class="form-control" aria-label="Sizing example input">
                    </div>
    ...
    <!--HAY QUE AGREGAR GESTIÓN DE USUARIOS PLUS, ASI SABER QUIENES SE SUSCRIBIERON
    AL PREMIUM, SUS NOMBRE Y DATOS. EN UNA TABLA QUE SAQUE LOS DATOS DE LA BD-->
